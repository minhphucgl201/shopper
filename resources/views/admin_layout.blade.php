            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-category-product')}}">Quản lí danh mục</a></li>
                    </ul>
				</li>
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-brand-product')}}">Quản lí hiệu san phẩm</a></li>
                    </ul>
				</li>
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						...
						<li><a href="{{URL::to('/all-product')}}">Quản lí san phẩm</a></li>
                    </ul>
                </li>
...
<!-- calendar -->
	...
	<script type="text/javascript">
		function sweetalert(){
				  Swal.fire('Add danh mục', 'Thành công', 'success');
			  }
	  </script>
	<!-- //calendar -->
